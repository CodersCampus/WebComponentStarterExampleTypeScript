...
This is a subset of the lit starter kit - what is missing is the 11ty site.
...
1. `src/my-element.ts` for the WebComponent code itself. Yup. One file, that's it.
2. `index.html` for the page that is "hosting" the web component.

The 3rd file you want to look for is `my-element.js` which is the javascript file that is compiled _from_ the `src/my-element.ts` source file. This file is imported into the `index.html` noted above.
